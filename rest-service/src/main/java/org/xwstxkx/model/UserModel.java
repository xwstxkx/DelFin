...
public class UserModel {
    ...
    public static UserModel toModel(RestUser entity) {
    ...
    public static List<UserModel> toListModel(List<RestUser> entities) {
        List<UserModel> models = new ArrayList<>();
        for (RestUser entity : entities) {
            models.add(toModel(entity));
        }
        return models;
    }

    public static RestUser toEntity(UserModel model) throws ObjectNotFound {
